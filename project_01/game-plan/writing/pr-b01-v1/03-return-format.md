# Attached return contract — YEOWUL-PR-B01-v1

Task-specific IDs, outputs and source versions are in00-task.md. This contract is included in full; relative repository links have been removed. Normative production and character rules are included in01-writing-context.md. No external document lookup is required.
