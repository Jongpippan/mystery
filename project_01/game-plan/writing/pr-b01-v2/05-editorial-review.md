# Editorial instructions attached to YEOWUL-PR-B01-v2

The following Codex review concerns the two actual r01 candidate files also attached. This is the revision assignment, not a request for user approval.
