...
for(const entry of ['state','case','presentation','script','save-store','epilogue','evidence-index','record-index'])await build({entryPoints:[`lib/game/${entry}.ts`],bundle:true,platform:'node',format:'cjs',outfile:join(temp,`${entry}.cjs`),alias:{'@':resolve('.')},logLevel:'silent'});
